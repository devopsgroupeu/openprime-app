...
export const SERVICES_CONFIG = {
  ...
  s3: {
    ...
    fields: {
      ...
      encryptionType: {
        ...
        name: "encryptionType",
        displayName: "Encryption Type",
        description: "Default encryption type for buckets",
        defaultValue: "AES256",
        options: [
          { value: "AES256", label: "AES256 (Server-side)" },
      ...
      loggingTargetBucket: {
        type: FIELD_TYPES.TEXT,
        name: "loggingTargetBucket",
        displayName: "Logging Target Bucket",
      ...
      objectOwnership: {
        ...
        options: [
          { value: "BucketOwnerEnforced", label: "Bucket Owner Enforced" },
  ...
  lambda: {
    ...
    fields: {
      ...
      defaultMemory: {
        ...
        description: "Default memory allocation for functions",
        defaultValue: 256,
        options: [
      ...
      defaultHandler: {
        ...
        description: "Default function handler (e.g., index.handler)",
        defaultValue: "index.handler",
      },
      ephemeralStorageSize: {
        type: FIELD_TYPES.NUMBER,
        name: "ephemeralStorageSize",
        displayName: "Ephemeral Storage (MB)",
        description: "Ephemeral storage size for /tmp directory",
        defaultValue: 512,
        min: 512,
        max: 10240,
      },
  ...
  elasticache: {
    ...
    description: "In-memory caching service - Redis, Valkey, or Memcached",
    provider: "aws",
    category: "Database",
    fields: {
      enabled: {
      ...
      engine: {
        ...
        defaultValue: "valkey",
        options: [
          { value: "valkey", label: "Valkey (Open-source Redis alternative)" },
      ...
      engineVersion: {
        ...
        name: "engineVersion",
        displayName: "Engine Version",
        description: "Cache engine version (e.g., 7.2 for Valkey/Redis, 1.6.17 for Memcached)",
        defaultValue: "7.2",
      },
      nodeType: {
        type: FIELD_TYPES.DROPDOWN,
        ...
        options: [
          { value: "cache.t4g.micro", label: "cache.t4g.micro (Graviton - 0.5GB)" },
          { value: "cache.t4g.small", label: "cache.t4g.small (Graviton - 1.37GB)" },
          { value: "cache.t4g.medium", label: "cache.t4g.medium (Graviton - 3.09GB)" },
          { value: "cache.t3.micro", label: "cache.t3.micro (0.5GB)" },
          { value: "cache.t3.small", label: "cache.t3.small (1.37GB)" },
          { value: "cache.t3.medium", label: "cache.t3.medium (3.09GB)" },
          { value: "cache.r6g.large", label: "cache.r6g.large (Graviton - 13.07GB)" },
          { value: "cache.r7g.large", label: "cache.r7g.large (Graviton - 13.07GB)" },
        ],
      },
      numCacheNodes: {
        type: FIELD_TYPES.NUMBER,
      ...
      snapshotWindow: {
        ...
        description: "Daily time range for automatic snapshots (e.g., 03:00-05:00)",
      ...
      automaticFailover: {
        ...
        description: "Enable automatic failover to replica (requires Multi-AZ)",
        defaultValue: false,
      },
      multiAz: {
        type: FIELD_TYPES.TOGGLE,
  ...
  sqs: {
    ...
    fields: {
      ...
      fifoQueues: {
        ...
        description: "Enable FIFO (First-In-First-Out) queues",
        defaultValue: false,
      },
      ...
      visibilityTimeout: {
        ...
        description: "Message visibility timeout (0-43200)",
        defaultValue: 30,
        min: 0,
        max: 43200,
      },
      messageRetention: {
        ...
        description: "Message retention period (60-1209600)",
        defaultValue: 345600,
        min: 60,
        max: 1209600,
      },
      maxMessageSize: {
        ...
        description: "Maximum message size (1024-262144)",
        defaultValue: 262144,
        min: 1024,
        max: 262144,
      },
      delaySeconds: {
        ...
        description: "Delay message delivery (0-900)",
        defaultValue: 0,
        min: 0,
        max: 900,
      },
  ...
  sns: {
    ...
    fields: {
      ...
      fifoTopics: {
        ...
        description: "Enable FIFO (First-In-First-Out) topics",
        defaultValue: false,
      },
      contentBasedDeduplication: {
        type: FIELD_TYPES.TOGGLE,
      ...
      kmsKeyId: {
        ...
        description: "KMS key ID for topic encryption (leave empty for default)",
        defaultValue: null,
      },
    },
  },
  ...
  cloudfront: {
    ...
    fields: {
      ...
      distributionNames: {
        ...
        displayName: "Distribution Names/Aliases",
        description: "List of CloudFront distribution domain names/aliases",
        defaultValue: [],
      },
      priceClass: {
        type: FIELD_TYPES.DROPDOWN,
        ...
        description: "CloudFront edge location pricing tier",
      ...
      enableIpv6: {
        ...
        description: "Enable IPv6 support for distributions",
        defaultValue: true,
      },
      enableWaf: {
        type: FIELD_TYPES.TOGGLE,
        ...
        description: "Enable AWS WAF web application firewall",
        defaultValue: false,
      },
      enableLogging: {
        type: FIELD_TYPES.TOGGLE,
  ...
  route53: {
    ...
    fields: {
      ...
      zoneNames: {
        type: FIELD_TYPES.ARRAY,
        name: "zoneNames",
        displayName: "Hosted Zone Domain Names",
        description: "List of domain names for Route53 hosted zones (e.g., example.com)",
        defaultValue: [],
      },
      privateZones: {
        type: FIELD_TYPES.TOGGLE,
      ...
      forceDestroy: {
        ...
        description: "Allow deletion of zones that contain records",
        defaultValue: false,
      },
      enableDnssec: {
        type: FIELD_TYPES.TOGGLE,
        ...
        description: "Enable DNSSEC signing for hosted zones",
        defaultValue: false,
      },
    },
  },
