  ...
  vpc: {
    ...
    fields: {
      ...
      createIntraSubnets: {
        ...
        description: "Create intra subnets",
        defaultValue: true,
      },
  ...
  eks: {
    ...
    fields: {
      ...
      defaultNodeGroupInstanceType: {
        type: FIELD_TYPES.DROPDOWN,
        name: "defaultNodeGroupInstanceType",
        displayName: "Default Node Group Instance Type",
        description: "Instance Type of Default Node Grpup",
  ...
  rds: {
    ...
    fields: {
      ...
      enhancedMonitoring: {
        ...
        displayName: "Enhanced Monitoring",
  ...
  opensearch: {
    ...
    fields: {
      ...
      cognitoEnabled: {
        type: FIELD_TYPES.TOGGLE,
        name: "cognitoEnabled",
        displayName: "Cognito Authentication",
